...
Show.create(title:"Goats", :channel => 20, :start_time => Time.now, :end_time => end_time_full_hour,)
Show.create(title:"Funniest Home Videos", :channel => 45, :start_time => Time.now+205.minutes, :end_time => Time.now+265.minutes)
